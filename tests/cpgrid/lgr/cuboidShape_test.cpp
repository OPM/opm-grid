...
bool checkCuboidShape(const Dune::cpgrid::Entity<0>& element, const Dune::CpGrid& grid)
{
    ...
    // Select four key corners to approximate cuboid volume
    // Recall that bottom face corners {0,1,2,3}, top face corners {4,5,6,7}
...
-- COORD: 4 pillars × 6 values (x1 y1 z1  x2 y2 z2)
COORD
 0 0 0    0 0 6     -- Pillar 1
 2 0 0    3 1 7     -- Pillar 2
 0 2 0   -1 3 5     -- Pillar 3
 2 2 0    4 4 8     -- Pillar 4
/

ZCORN
-- ZCORN: 2 cells stacked vertically => 16 values
-- Cell 1 (bottom)
0 0 0 0    -- bottom near pillars 1..4
2 3 1 4    -- top near pillars 1..4

-- Cell 2 (above cell 1)
2 3 1 4    -- bottom = same as cell 1 top
5 7 4 8    -- top near pillars 1..4
/
ACTNUM
 2*1
/
