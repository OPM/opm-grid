...
namespace Dune
{
    ...
    public:
        ...
        void processEclipseFormat(Opm::EclipseState& ecl_state, const Opm::Deck& deck, const Opm::EclipseGrid* ecl_grid, bool periodic_extension, Opm::NNC&, bool turn_normals = false, bool clip_z = false,
